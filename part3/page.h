...
// Class definition for a ubase data page.   
...
public:
    ...
    const short getSlotCnt() const; // returns slot count
    const short getFreePtr() const; // returns free pointer
    const short getOffset(const int i) const; // returns slot[i].offset
    const short getLength(const int i) const; // returns slot[i].length
